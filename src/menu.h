...
public:
    ...
    QStringList getMenuItems();   //return the list of submenu titles
    Menu* getParent();   //return a pointer to the parent menu
...
private:
	...
	QStringList menuItems;    //a list of selection items for each menu object
	...
	Menu* parent;    //represents the parent menu of this menu object in a tree structure
